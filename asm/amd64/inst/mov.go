...
var MOV = &InstSet{"mov", S32, []Inst{
	...
	{M8_R8h, 0, Rex, C1 | 0x88},         // Move r8 to r/m8.
	{M16_R16, AddrOpSize, 0, C1 | 0x89}, // Move r16 to r/m16.
	{M32_R32, 0, 0, C1 | 0x89},          // Move r32 to r/m32.
	{M64_R64, 0, RexW, C1 | 0x89},       // Move r64 to r/m64.
	{R8_M8, 0, 0, C1 | 0x8A},            // Move r/m8 to r8.
	{R8_M8h, 0, Rex, C1 | 0x8A},         // Move r/m8 to r8.
	{R16_M16, AddrOpSize, 0, C1 | 0x8B}, // Move r/m16 to r16.
	{R32_M32, 0, 0, C1 | 0x8B},          // Move r/m32 to r32.
	{R64_M64, 0, RexW, C1 | 0x8B},       // Move r/m64 to r64.
	{O8_I8, 0, 0, C1 | 0xB0},            // Move imm8 to r8.
	{O8_I8h, 0, Rex, C1 | 0xB0},         // Move imm8 to r8.
	{M8_I8, 0, 0, C1 | 0xC6},            // Move imm8 to r/m8.
	{M8_I8h, 0, Rex, C1 | 0xC6},         // Move imm8 to r/m8.
	{O16_I16, OpSize, 0, C1 | 0xB8},     // Move imm16 to r16.
	{M16_I16, OpSize, 0, C1 | 0xC7},     // Move imm16 to r/m16.
